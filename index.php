...
<tr>
   <td valign=middle><b><font size=+2>City Water Intake</font></b></td>
   <td width=10></td>
   ...
   ?></td></tr></table>
   <b>note:</b> time scales over 1 month are slow to update--wait for graphs<br>
<? for ($i=1;$i<=3;++$i) { ?>
